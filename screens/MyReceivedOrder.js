...
class MyReceivedOrder extends React.Component {
    constructor(){
        super();
        this.state ={
            ready:false,
    ...
    fetchData = async () => {
        ...
        await axiosService.get('/my-received-order',{
        ...
        return (
            <View >
                ...
                <View style={this.state.ready ? {padding:2} : {display:'none'}}>
                    ...
                    <ScrollView>
                        <View>
                            <View style={this.state.show_peding_tab ? {overflow:'scroll'}: {display:'none'}}>
                                <FlatList
                                    nestedScrollEnabled 
                                    horizontal={false}
                            ...
                            <View style={this.state.show_in_progress_tab ? {overflow:'scroll'} : {display:'none'}}>
                                <FlatList
                                    nestedScrollEnabled 
                                    horizontal={false}
                            ...
                            <View style={this.state.show_completed_tab ?{overflow:'scroll'} : {display:'none'}}>
                                <FlatList
                                    nestedScrollEnabled 
                                    horizontal={false}
...
export default MyReceivedOrder;