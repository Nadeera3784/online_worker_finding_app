...
class OrderFilterLocation extends React.Component {
    constructor(){
        super();
        this.state ={
            ready:false,
 ...
 ` + data;
    ...
    continueNext = async () => {
        ...
        this.props.navigation.navigate('OrderSelectWorker',{
            location_id:this.state.checkedId
        });
    }
    showItems =  (item,id) =>{
            ...
            <View style={styles.container}>
                ...
                <View style={{ flex: 9, }}>
                    <CheckBox
                        ...
                        checkedIcon='dot-circle-o'
                        uncheckedIcon='circle-o'
                        checked={0 == this.state.checkedId}
...
export default OrderFilterLocation;